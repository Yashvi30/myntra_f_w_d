...
import 'master_class_register_model.dart';
export 'master_class_register_model.dart';

class MasterClassRegisterWidget extends StatefulWidget {
  const MasterClassRegisterWidget({super.key});

  @override
  State<MasterClassRegisterWidget> createState() =>
      _MasterClassRegisterWidgetState();
}

class _MasterClassRegisterWidgetState extends State<MasterClassRegisterWidget> {
  late MasterClassRegisterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MasterClassRegisterModel());
  }
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 8.0, 0.0, 12.0),
                                  child: Text(
                                    'Master the Essentials of Fabric Selection and Usage with Niti Malhotra. Get an Introduction to Eco-Friendly Fashion Design Practices',
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                          fontFamily: 'Readex Pro',
