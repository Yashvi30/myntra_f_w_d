...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/fashhub',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Fashhub')
              : FashhubWidget(),
        ),
        FFRoute(
          name: 'Videopage',
        ...
        FFRoute(
          name: 'MasterClassRegister',
          path: '/masterClassRegister',
          builder: (context, params) => MasterClassRegisterWidget(),
        ),
        FFRoute(
          name: 'Product',
          path: '/product',
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Center(
                    child: Image.asset(
                      'assets/images/Myntra-logo-horizontal-white1.png',
                      width: 200.0,
