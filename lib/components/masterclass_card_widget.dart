...
import 'masterclass_card_model.dart';
...
class _MasterclassCardWidgetState extends State<MasterclassCardWidget> {
  late MasterclassCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MasterclassCardModel());
  }
